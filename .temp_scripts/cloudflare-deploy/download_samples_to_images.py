#!/usr/bin/env python3
"""
Download sample images with original filenames to images/ directory
"""

import requests
from pathlib import Path

# New image URLs provided by user with original filenames
new_images = [
    {
        ...
        "filename": "sample_微信圖片_20260321162810_44_2.jpg",
        "title": "Crystal Product 1"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321165154_518_2.jpg",
        "title": "Crystal Product 2"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321165225_547_2.jpg",
        "title": "Crystal Product 3"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321165229_552_2.jpg",
        "title": "Crystal Product 4"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321162605_25_2.jpg",
        "title": "Crystal Product 5"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321163151_67_2.jpg",
        "title": "Crystal Product 6"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321165244_569_2.jpg",
        "title": "Crystal Product 7"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321165337_622_2.jpg",
        "title": "Crystal Product 8"
    },
    {
        ...
        "filename": "sample_微信圖片_20260321165358_643_2.jpg",
        "title": "Crystal Product 9"
    },
    {
        ...
        "filename": "sample_5_arms_candelabras.jpg",
        "title": "5 Arms Candelabras"
    },
    {
        ...
        "filename": "sample_9_arms_candelabra.jpg",
        "title": "9 Arms Candelabra"
    },
    {
        ...
        "filename": "sample_9_candlesticks_candelabra.jpg",
    ...
    },
    {
        ...
        "filename": "sample_candle_holder.jpg",
        "title": "Candle Holder"
    },
    {
        ...
        "filename": "sample_candlestick.jpg",
        "title": "Candlestick"
    }
]

def download_images():
    """Download all new images to images/ directory"""
    
    # Create images directory if it doesn't exist
    images_dir = Path("images")
    images_dir.mkdir(exist_ok=True)
    
    print(f"Downloading {len(new_images)} images to {images_dir}/")
    print("=" * 60)
