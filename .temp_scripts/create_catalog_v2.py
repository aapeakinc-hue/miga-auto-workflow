...
class ProductPage:
    """Custom class to create product pages"""
    ...
    def drawOn(self, canvas, x, y):
        ...
        if os.path.exists(img_path):
            try:
                ...
                canvas.drawImage(img_bytes, x_pos, y_pos,
...
class CoverPage:
    """Custom class to create cover page"""
    def wrap(self, availWidth, availHeight):
        return (availWidth, availHeight)
...
def generate_catalog():
    ...
    output_file = "assets/MIGAC_CATALOG_2025.pdf"
    ...
    story.append(Spacer(0, landscape(A4)[1]))
